...
entity.get = function (callback) {
  this.request(this.url(), 'GET', function (err, response, data) {
    callback(err, data);
  });
}
...
entity.update = function (data, callback) {
  ...
  this.request(this.url(), 'PUT', requestBody, function (err, response, body) {
    callback(err, body);
  });
...
entity.remove = function (callback) {
  this.request(this.url(), 'DELETE', function (err, response, body) {
    callback(err, body);
  });
}
